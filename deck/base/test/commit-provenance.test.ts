...
import { signCommitObject, verifyCommitObject, readCommit, type Commit } from '@term/base/code/commit/commit'
...
import { sync, commitChanges } from '@term/base/code/project/feed'
