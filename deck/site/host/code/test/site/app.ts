...
export function writeSignal<T>(self: Signal, value: T): number {
  self.value = value
...
export function mountApp(host: View): number {
  const label = { value: "ready", observers: [] }
  const root = { handle: { tag: "div", text: "", value: "", attributes: [], styles: [], classes: [], children: [], listeners: [], parent: { form: "none" } } }
  const button = { handle: { tag: "button", text: "", value: "", attributes: [], styles: [], classes: [], children: [], listeners: [], parent: { form: "none" } } }
  event(button, "click", () => {
  writeSignal(label, "clicked")
})
  append(button, { handle: { tag: "", text: "click me", value: "", attributes: [], styles: [], classes: [], children: [], listeners: [], parent: { form: "none" } } })
  append(root, button)
