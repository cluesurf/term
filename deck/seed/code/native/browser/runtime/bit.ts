// Bitwise integer operations over the Web platform. The JavaScript bitwise operators are 32-bit; keep operands within
// 32 bits on this target. Reached only through the public bit API.
const bit = {
