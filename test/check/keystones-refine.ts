...
expect('floor: at dim 2, spinor 1 < vector 2', proves([], below(lit(1), lit(2))), true)
expect('floor: at dim 4, spinor 2 < vector 4', proves([], below(lit(2), lit(4))), true)
expect('floor: at dim 6, spinor 4 < vector 6', proves([], below(lit(4), lit(6))), true)
expect('floor: at dim 8, spinor 8 = vector 8 (<=)', proves([], atMost(lit(8), lit(8))), true)
expect('floor: at dim 8, spinor 8 = vector 8 (>=)', proves([], atLeast(lit(8), lit(8))), true)
expect('floor: at dim 8, spinor is NOT below vector', proves([], below(lit(8), lit(8))), false)
expect('floor: at dim 10, spinor 16 > vector 10', proves([], above(lit(16), lit(10))), true)
...
expect('ceiling: the sedenion dimension 16 exceeds the ceiling 8', proves([], above(lit(16), lit(8))), true)
expect('ceiling: eight is not above eight (it is the top rung)', proves([], above(lit(8), lit(8))), false)
...
expect('pinch: ceiling and floor give dimension <= 8', proves(pinch, atMost(d, lit(8))), true)
expect('pinch: ceiling and floor give dimension >= 8', proves(pinch, atLeast(d, lit(8))), true)
expect('pinch: the dimension cannot be below 8', proves(pinch, below(d, lit(8))), false)
expect('pinch: the dimension cannot be above 8', proves(pinch, above(d, lit(8))), false)
