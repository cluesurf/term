...
export type Statement =
  ...
  | { form: 'if'; branches: { cond: Expression; body: Statement[] }[]; otherwise?: Statement[] }
  | { form: 'while'; cond: Expression; body: Statement[] }
  | { form: 'switch'; subject: Expression; cases: { match: Expression; body: Statement[] }[]; otherwise?: Statement[] }
  ...
  | { form: 'try'; body: Statement[]; catchName?: string; catchBody?: Statement[]; finallyBody?: Statement[] }
